...
public interface PlatziPlayAIService {
    @UserMessage("""
            ...
            Usa menos de 120 caracteristicas y hazlo con el estilo de Platzi.
            """)
    String generateGreeting(@V("platform") String platform);

    @SystemMessage("""
            Eres un experto en cine que recomienda películas personalizadas segÃºn los gustos del usuario.
